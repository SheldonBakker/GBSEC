...
const Academy: React.FC = () => {
  return (
    <div className="pt-24 md:pt-32 pb-40 px-6 md:px-16 space-y-12">
      {/* Header Section */}
      ...
      <section className="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
        ...
        >
          Our instructor, Matthew W Williams, is not only an instructor but an
          Assessor and Moderator registered with all the above-mentioned
          entities. His gradings and certificates are up-to-date and valid. With
          20 years of experience, he has built a reputation for having an "Above
          Standard" Portfolio of Evidence for his students.
        </motion.p>
        <motion.p
          className="mt-4 text-lg"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <li>
            Handle and Use of a Handgun for Tactical Purposes - Unit Standard
            123513
          </li>
          <li>
            Handle and Use of a Shotgun for Tactical Purposes - Unit Standard
            123512
          </li>
          <li>
            Handle and Use of a SL Rifle for Tactical Purposes - Unit Standard
            123518
          </li>
      ...
      <section className="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
        ...
        >
          Our newest member, Clifford van Haght, will complete his training and
          accreditation to become an Instructor and Assessor in October 2024. He
          has been under the guidance and training of Matthew W Williams.
        </motion.p>
      </section>
      ...
      <section className="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
        ...
        >
          In terms of the Firearms Control Act, 2000, all existing firearm
          licenses had to be renewed from 1 April 2004. Every person applying
          for a firearm license or renewal in South Africa must obtain a Firearm
          Competency Certificate from an accredited institution.
        </motion.p>
        <motion.p
          className="mt-4 text-lg"
          initial={{ opacity: 0 }}
        ...
        <div className="mt-6 space-y-4">
          ...
          >
            <h3 className="text-2xl font-semibold text-red-700 mb-2">
              Handgun Private (119649)
            </h3>
            <p className="text-lg">
              R800 (Excl. Ammo) - Ammo: R8.00 per round min 20 rounds = R160
            </p>
          </motion.div>
          <motion.div
            className="bg-gray-100 p-4 rounded-lg border border-gray-300"
          ...
          >
            <h3 className="text-2xl font-semibold text-red-700 mb-2">
              Shotgun Private (119652)
            </h3>
            <p className="text-lg">
              R800 (Excl. Ammo) - Ammo: R10.50 per round min 10 rounds = R105
            </p>
          </motion.div>
          <motion.div
            className="bg-gray-100 p-4 rounded-lg border border-gray-300"
          ...
          >
            <h3 className="text-2xl font-semibold text-red-700 mb-2">
              MO Rifle Private (119651)
            </h3>
            <p className="text-lg">
              R800 (Excl. Ammo) - Ammo: R3.30 per round min 20 rounds = R66
            </p>
          </motion.div>
          <motion.div
            className="bg-gray-100 p-4 rounded-lg border border-gray-300"
          ...
          >
            <h3 className="text-2xl font-semibold text-red-700 mb-2">
              Handgun Combo (649 & 515)
            </h3>
            <p className="text-lg">
              R2200 (Excl. Ammo) - Ammo: R8.00 per round min 70 rounds = R560
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
        ...
        >
          Take the manuals home and complete the tests inside in pen. Upon
          purchasing the manuals, you will be given a date for the next class.
          On this day, bring your ID book and completed tests to the office.
        </motion.p>
        <motion.p
          className="mt-4 text-lg"
          initial={{ opacity: 0 }}
        ...
        >
          Your open book test will be marked. If you pass, you will write the
          closed book test in the classroom. Upon passing both tests, you will
          be scheduled for your range shoot with an instructor.
        </motion.p>
      </section>
      ...
      <section className="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
        ...
        <div className="space-y-6">
          ...
          >
            <h3 className="text-2xl font-semibold text-red-700 mb-2">
              Handle Handgun for Tactical Purposes
            </h3>
            <p className="text-lg">Duration: 2 Days</p>
      ...
      <section className="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
        ...
        >
          Our Tactical Unit Standard courses are PFTC and ITA accredited and
          provide advanced training for high-risk situations where quick
          decision-making and skills are essential. These courses prepare
