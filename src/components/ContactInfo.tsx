        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-600 text-sm">(+27) 123-4567</p>
            </div>
            <div className="text-center lg:text-left">
              <h3 className="text-lg font-semibold text-gray-700 mb-1">Email</h3>
              <p className="text-gray-600 text-sm">info@gordonsbaysecurity.co.za</p>
            </div>
            <div className="text-center lg:text-left">
              <h3 className="text-lg font-semibold text-gray-700 mb-1">Address</h3>
              <p className="text-gray-600 text-sm">123 Main St, Gordons Bay</p>
            </div>
          </div>
